...
<template>
  <header
    class="relative z-10 h-16 w-full items-center bg-white shadow md:h-20"
  >
    <div class=" mx-auto w-full flex w-full h-full flex-col justify-center px-3">
      <div class="relative flex w-full w-full items-center pl-1 sm:ml-0 sm:pr-2">
        <div class="relative left-0 flex h-full w-3/4">
          ...
          <img class="h-10" src="https://a.imagem.app/ok70aJ.png" alt="" />
          <div class="group relative flex  w-full h-full pl-10 w-36 items-center lg:w-full">
            <div
              class="absolute flex h-10 w-auto pl-10 cursor-pointer items-center justify-center p-3 pr-2 text-sm uppercase text-gray-500 sm:hidden"
            >
              <svg
                fill="none"
                class="relative pl-10 h-5 w-5"
